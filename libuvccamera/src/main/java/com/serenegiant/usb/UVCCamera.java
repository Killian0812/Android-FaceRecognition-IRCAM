...
public class UVCCamera {
	public int mShowCamera = 0;
	private static final boolean DEBUG = false;	// TODO set false when releasing
	private static final String TAG = UVCCamera.class.getSimpleName();
	private static final String DEFAULT_USBFS = "/dev/bus/usb";

	public static final int DEFAULT_LPREVIEW_WIDTH = 640;
	public static final int DEFAULT_LPREVIEW_HEIGHT = 480;
	public static final int DEFAULT_RPREVIEW_WIDTH = 640;
	public static final int DEFAULT_RPREVIEW_HEIGHT = 480;
...
//    		mNativePtr = 0;	// nativeDestroyを呼ぶのでここでクリアしちゃダメ
	...
	public Size getPreviewSize() {
		...
		for (final Size sz: list) {
			Log.v("CameraResolution", "" + sz.width + "-" + sz.height);
    ...
    public synchronized void startPreview() {
    	if (mCtrlBlock != null) {
    		nativeStartPreview(mNativePtr, mShowCamera);
    	}
    }

	//hiephv
	public synchronized void changePreviewSetting() {
		if (mCtrlBlock != null) {
			Log.d("CameraThread", "mShowCamera = " + mShowCamera);
			nativeChangePreviewSetting(mNativePtr, mShowCamera);
		}
	}
...
//================================================================================
    ...
    private static final native int nativeStartPreview(final long id_camera, final int mShowCamera);
	private static final native int nativeChangePreviewSetting(final long id_camera, final int mShowCamera);
	public static final native String nativeSetActivityObject(final Object activity);
